Public Class ControlPanelHub
    ...
    Private Sub Timer2_Tick(sender As System.Object, e As System.EventArgs) Handles Timer2.Tick
        Try
            If show_keyboard.Value = True Then
                Shell("C:\Windows\System32\osk.exe")
            End If
            Timer2.Stop()
        Catch ex As Exception
            MessageBox.Show("Unable to Open Keyboard on Screen", "", MessageBoxButtons.RetryCancel, MessageBoxIcon.Information)
        End Try
